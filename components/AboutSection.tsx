        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="max-w-2xl border-l-2 border-black/5 pl-8 md:pl-12">
              <p className="text-lg md:text-2xl text-[#7F7F7F] font-medium leading-[1.6] mb-8">
          ...
          <div className="lg:col-span-4 space-y-20 pt-12">
            ...
            <div className="relative group">
              <p className="text-[10px] font-bold tracking-[0.2em] text-[#7F7F7F] uppercase mb-4 group-hover:text-black transition-colors">State Network</p>
              ...
              <p className="text-sm text-[#7F7F7F] font-medium leading-relaxed mt-4">
            ...
            <div className="pt-10 border-t border-black/5">
              ...
              <p className="text-sm md:text-base text-[#7F7F7F] font-medium leading-relaxed">
